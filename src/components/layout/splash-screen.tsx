 ...
 * تم تقليل الوقت إلى ثانية واحدة لضمان سرعة الوصول لواجهة الدخول.
 */
export function SplashScreen({ 
  ...
  // تقليل وقت الهوية البصرية لضمان عدم تأخر واجهة الدخول
  useEffect(() => {
  ...
  // الاختفاء التلقائي عند جاهزية التطبيق ومرور الثانية الواحدة
  useEffect(() => {
  ...
  return (
    <div 
      className={cn(
        "fixed inset-0 z-[10000] flex flex-col items-center justify-center bg-mesh-gradient transition-all duration-700 ease-in-out",
    ...
    >
      ...
      <div className="relative flex flex-col items-center text-center space-y-8 px-6 max-w-sm w-full">
        
        {/* الشعار */}
        <div className="relative w-32 h-32 mb-4">
            <div className="absolute inset-0 bg-white/20 rounded-[45px] blur-2xl" />
        ...
        <div className="space-y-3">
            <h1 className="text-3xl font-black text-white tracking-tight drop-shadow-md">ستار موبايل</h1>
            <p className="text-white/80 text-sm font-bold tracking-wide">عالم من الخدمات بين يديك</p>
        </div>
        ...
        <div className="pt-12 flex flex-col items-center space-y-4">
            ...
            <p className="text-white font-black text-xs tracking-[0.2em] opacity-80">جاري التحضير...</p>
        </div>
